...
use attestation as pallet_attestation;
use ctype as pallet_ctype;
use delegation as pallet_delegation;
...
impl pallet_attestation::Config for Runtime {
	...
	type AuthorizationId = AuthorizationId<<Runtime as pallet_delegation::Config>::DelegationNodeId>;
	type AccessControl = PalletAuthorize<pallet_delegation::DelegationAc<Runtime>>;
}
...
impl pallet_proxy::Config for Runtime {
	...
	type Call = Call;
	type Currency = Balances;
	type ProxyType = access_control::ProxyType;
